...
namespace art {
    struct ScopeManagerMap {
        ...
        ScopeManagerMap(ScopeManager& manager)
            : manager(manager) {}
    ...
    public:
        ...
        struct DynamicCompiler {
            ...
            DynamicCompiler(Compiler& compiler)
                : compiler(compiler) {}
            ...
            struct ArrayOperation {
                ...
                ArrayOperation(Compiler& compiler, const ValueIndexPos& array, OpArrFlags flags)
                    : compiler(compiler), array(array), flags(flags) {}
        ...
        struct StaticCompiler {
            ...
            StaticCompiler(Compiler& compiler)
                : compiler(compiler) {}
            ...
            struct ArrayOperation {
                ...
                ArrayOperation(Compiler& compiler, const ValueIndexPos& array, OpArrFlags flags, ValueMeta array_meta)
                    : compiler(compiler), array(array), flags(flags), array_meta(array_meta) {}

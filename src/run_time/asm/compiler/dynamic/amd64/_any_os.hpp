...
namespace art {
    ...
    void Compiler::DynamicCompiler::create_saarr(const ValueIndexPos& value_index, uint32_t length) {
        CASM& a = compiler.a;
        BuildCall b(a, 1);
    ...
    void Compiler::DynamicCompiler::compare(const ValueIndexPos& a_v, const ValueIndexPos& b_v) {
        CASM& a = compiler.a;
        a.push_flags();
        a.pop(argr0_16);

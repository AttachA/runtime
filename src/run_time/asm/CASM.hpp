...
#define callStart()
    ...
    public:
        ...
        inline void addArg(bool val) {
            addArg(val, 8);
        }

        inline void addArg(int8_t val) {
            addArg(val, 8);
        }

        inline void addArg(uint8_t val) {
            addArg(val, 8);
        }

        inline void addArg(int16_t val) {
            addArg(val, 8);
        }

        inline void addArg(uint16_t val) {
            addArg(val, 8);
        }

        inline void addArg(int32_t val) {
            addArg(val, 8);
        }

        inline void addArg(uint32_t val) {
            addArg(val, 8);
        }

        inline void addArg(int64_t val) {
            addArg(val, 8);
        }

        inline void addArg(uint64_t val) {
            addArg(val, 8);
        }

        inline void addArg(float val) {
            addArg(val, 8);
        }

        inline void addArg(double val) {
            addArg(val, 8);
        }

        inline void addArg(void* val) {
            addArg(val, 8);
        }

...
namespace art{
	...
	public:
		...
		void handle(void* unused0, NativeWorkerHandle* unused1, unsigned long unused2, bool unused3){actual_handle();}
		#elif defined(PLATFORM_LINUX)
		void handle(NativeWorkerHandle* unused1, io_uring_cqe* unused){actual_handle();}
		#else

...
namespace art {
    ...
    public:
        ...
        i_p_optional(const T& value)
            : v(value), contains_value(true) {}

        i_p_optional(T&& value)
            : v(std::move(value)), contains_value(true) {}

        i_p_optional(const i_p_optional& other)
            : contains_value(other.contains_value) {
            if (contains_value)
                new (&v.value) T(other.value);
        }

        i_p_optional(i_p_optional&& other)
            : contains_value(other.contains_value) {
            if (contains_value)

...
#define lgr_move_snapshot(snap_records_src, snap_records_dst, current_snap_src, current_snap_dst) \
    snap_records_dst = snap_records_src;                                                          \
    current_snap_dst = current_snap_src;                                                          \
    current_snap_src = nullptr;                                                                   \
    snap_records_dst = nullptr;
#define rm_lgr_snap_records     \
    if (snap_records) {         \
        delete snap_records;    \
        snap_records = nullptr; \
    }

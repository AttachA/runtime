...
namespace art {
    ...
    public:
        ...
        ustring(const char* begin, const char* end):ustring(begin,end-begin){}
        ustring(const char8_t* begin, const char8_t* end):ustring(begin,end-begin){}
        ustring(const char16_t* begin, const char16_t* end):ustring(begin,end-begin){}
        ustring(const char32_t* begin, const char32_t* end):ustring(begin,end-begin){}

        ustring(char str) : ustring(&str,1){}
        ustring(char8_t str) : ustring(&str,1){}
        ustring(char16_t str) : ustring(&str,1){}
        ustring(char32_t str) : ustring(&str,1){}
        ...
        template<size_t len>
        void append(const char str[len]){append(str,len);}
        template<size_t len>
        void append(const char8_t str[len]){append(str,len);}
        template<size_t len>
        void append(const char16_t str[len]){append(str,len);}
        template<size_t len>
        void append(const char32_t str[len]){append(str,len);}
        ...
        /*[[INTERNAL]]*/ char& operator[](size_t i){return data()[i];}
        /*[[INTERNAL]]*/ const char& operator[](size_t i) const {return c_str()[i];}
    };
